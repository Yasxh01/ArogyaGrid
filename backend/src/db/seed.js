...
async function seedDatabase() {
  ...
  store.beds = [
    { id: 'BED-RAN-01-GEN', phc_id: 'PHC-RAN-01', bed_type: 'GENERAL', total_beds: 30, occupied_beds: 18 },
    { id: 'BED-RAN-01-OXY', phc_id: 'PHC-RAN-01', bed_type: 'OXYGEN', total_beds: 15, occupied_beds: 7 },
    { id: 'BED-RAN-01-ICU', phc_id: 'PHC-RAN-01', bed_type: 'ICU', total_beds: 5, occupied_beds: 2 },
    { id: 'BED-RAN-03-GEN', phc_id: 'PHC-RAN-03', bed_type: 'GENERAL', total_beds: 25, occupied_beds: 24 },
    { id: 'BED-RAN-03-OXY', phc_id: 'PHC-RAN-03', bed_type: 'OXYGEN', total_beds: 10, occupied_beds: 10 },
    { id: 'BED-RAN-03-ICU', phc_id: 'PHC-RAN-03', bed_type: 'ICU', total_beds: 5, occupied_beds: 5 }
  ];
  ...
  store.users = [
    ...
    { id: 'USR-DO-RAN', name: 'District Officer Ranchi', email: 'district.ranchi@arogyagrid.gov.in', password_hash: passwordHash, role: 'DISTRICT_OFFICER', district_id: 'DIST-JH-01' },
    { id: 'USR-PHC-RAN01', name: 'Sadar PHC Medical Officer', email: 'phc.ranchi01@arogyagrid.gov.in', password_hash: passwordHash, role: 'PHC_STAFF', district_id: 'DIST-JH-01', phc_id: 'PHC-RAN-01' },
    { id: 'USR-PHC-RAN03', name: 'Namkum PHC In-Charge', email: 'phc.ranchi03@arogyagrid.gov.in', password_hash: passwordHash, role: 'PHC_STAFF', district_id: 'DIST-JH-01', phc_id: 'PHC-RAN-03' }
  ];
