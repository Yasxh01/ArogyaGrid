...
router.get('/batches/:phcId?', authenticateToken, stockController.getBatches);
router.post('/batches', authenticateToken, authorizeRoles('ADMIN', 'DISTRICT_OFFICER', 'PHC_OPERATOR'), stockController.createBatch);
